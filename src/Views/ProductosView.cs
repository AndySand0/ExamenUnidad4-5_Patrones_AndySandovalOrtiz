...
{
    private readonly ProductosController _controller = new();
    ...
    public void MostrarMenu()
    {
        ...
        do
        {
            ...
            switch (opcion)
            {
                ...
                case 7: _controller.Deshacer(); break;
    ...
    private void CrearProducto()
    {
        ...
        var p = _controller.CrearProducto(id, nombre, precio,
    ...
    private void AgregarCategoria()
    {
        ...
        _controller.AgregarCategoria(id, cat);
    }
    ...
    private void AgregarMarca()
    {
        ...
        _controller.AgregarMarca(id, marca);
    }
    ...
    private void AgregarEtiqueta()
    {
        ...
        _controller.AgregarEtiqueta(id, clave, valor);
    }

    private void VerProducto()
    {
        Console.Write("ID: "); int id = int.Parse(Console.ReadLine());
        var p = _controller.ObtenerProducto(id);
    ...
    {
        foreach (var p in _controller.ListarProductos())
